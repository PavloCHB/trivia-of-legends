...
class Regions extends Component {
    constructor(props){
        ...
        this.state = {
            regions: [
                ...
                {
                    name: "Ixtal",
                    info: ["Renowned for its mastery of elemental magic, Ixtal was one of the first independent nations to join the Shuriman empire. In truth, Ixtali culture is much older—part of the great westward diaspora that gave rise to civilizations including the Buhru, magnificent Helia, and the ascetics of Targon—and it is likely they played a significant role in the creation of the first Ascended.",
                ...
                {
                    name: "Noxus",
                    info: ["Noxus is a powerful empire with a fearsome reputation. To those beyond its borders, it is brutal, expansionist, and threatening, yet those who look past its warlike exterior see an unusually inclusive society, where the strengths and talents of its people are respected and cultivated.",
                ...
                {
                    name: "Shurima",
                    info: ["The empire of Shurima was once a thriving civilization that spanned an entire continent. Forged in a bygone age by the mighty god-warriors of the Ascended Host, it united all the disparate peoples of the south, and enforced a lasting peace between them.",
                ...
                {
                    name: "The Freljord",
                    info: ["The Freljord is a harsh and unforgiving place—where the people are born warriors, who must persevere against all odds.",
                ...
                {
                    name: "The Void",
                    info: ["Screaming into existence with the birth of the universe, the Void is a manifestation of the unknowable nothingness that lies beyond. It is a force of insatiable hunger, waiting through the eons until its masters, the mysterious Watchers, mark the final time of undoing.",
    ...
    render() { 
        return (  
            <>
                <NavBar/>
                <h1 className='regions-tittle'>Regions of Runeterra</h1>
                <div className="container-regions">
                    {this.state.regions.map((region) => (
                        <Region
                        name = {region.name}
                        id = {region.name.toLowerCase().replaceAll(" ","-")}
                        info = {region.info.map((paragraph)=>(<p>{paragraph}</p>))}
